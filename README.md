...
| **วินิจฉัย** | บันทึกสาเหตุ/แผนซ่อม, ระบุอะไหล่ที่ต้องใช้พร้อม**ตัดสต็อกอัตโนมัติ**จากรหัสอะไหล่ในคลัง |
...
- เพิ่มช่อง **ตัดสต็อก** ใน tab **วินิจฉัย** ของหน้าใบงาน: กรอก **รหัสอะไหล่** (มี autocomplete จากคลังอะไหล่) + จำนวน แล้วกด **➖ ตัดสต็อก** ระบบจะเรียก `updateInventory` (qtyChange ติดลบ) ตัดยอด **จำนวนคงเหลือ** ในคลังอะไหล่ทันที และแทรกรายการ "รหัส (ชื่อ) xจำนวน" ลงในช่อง **อะไหล่ที่ต้องใช้** ให้อัตโนมัติ
- หากสต็อกคงเหลือน้อยกว่าจำนวนที่ต้องการตัด ระบบจะแจ้งเตือนและให้ยืนยันก่อนตัดสต็อกติดลบ
- หากใส่รหัสอะไหล่ที่ไม่มีในคลัง ระบบจะแจ้งเตือนและไม่ตัดสต็อก
